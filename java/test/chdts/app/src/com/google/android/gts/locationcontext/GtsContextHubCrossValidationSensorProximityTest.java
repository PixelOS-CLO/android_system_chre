...
/**
 * A test of CHRE proximity sensor data as compared to host data.
 */
@RunWith(JUnit4.class)
public final class GtsContextHubCrossValidationSensorProximityTest
    ...
    @Before
    public void setUp() {
        setUpCrossValidator(Sensor.TYPE_PROXIMITY);
    }
}
