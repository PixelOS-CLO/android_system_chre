...
/**
 * A test of CHRE magnetic field sensor data as it compares to host.
 */
@RunWith(JUnit4.class)
public final class GtsContextHubCrossValidationSensorMagneticFieldTest
    ...
    @Before
    public void setUp() {
        setUpCrossValidator(Sensor.TYPE_MAGNETIC_FIELD);
    }
}
