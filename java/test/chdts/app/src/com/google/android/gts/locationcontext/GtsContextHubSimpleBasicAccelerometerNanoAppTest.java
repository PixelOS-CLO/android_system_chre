...
public class GtsContextHubSimpleBasicAccelerometerNanoAppTest
        extends GtsContextHubSimpleNanoAppTestBase {

    private static final String TAG = "GtsContextHubSimpleBasicAccelerometerNanoAppTest";
    @Rule public final GtsContextHubTestModeRule mTestModeRule = new GtsContextHubTestModeRule();

    @Override
    protected TestNames[] getTestNames() {
        return new TestNames[] {TestNames.BASIC_ACCELEROMETER};
    }

    @Override
    protected long getTestTimeoutSeconds() {
        return BASIC_SENSOR_TIMEOUT;
    }

    @Override
    protected void loadAndStart() {
        Log.d(TAG, "restrict sensors for BASIC_ACCELEROMETER test");
        ChreTestUtil.restrictSensors("com.google.android.gts.locationcontext"
                    + ".GtsContextHubSimpleBasicAccelerometerNanoAppTest");
