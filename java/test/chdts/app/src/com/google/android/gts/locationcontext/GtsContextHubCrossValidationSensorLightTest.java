...
/**
 * A test of CHRE light sensor data as compared to host data.
 */
@RunWith(JUnit4.class)
public final class GtsContextHubCrossValidationSensorLightTest
    ...
    @Before
    public void setUp() {
        setUpCrossValidator(Sensor.TYPE_LIGHT);
    }
}
