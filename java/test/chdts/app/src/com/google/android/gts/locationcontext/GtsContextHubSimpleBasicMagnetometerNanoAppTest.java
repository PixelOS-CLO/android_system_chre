...
public class GtsContextHubSimpleBasicMagnetometerNanoAppTest
        extends GtsContextHubSimpleNanoAppTestBase {

    private static final String TAG = "GtsContextHubSimpleBasicMagnetometerNanoAppTest";
    @Rule public final GtsContextHubTestModeRule mTestModeRule = new GtsContextHubTestModeRule();

    @Override
    protected TestNames[] getTestNames() {
        return new TestNames[] {TestNames.BASIC_MAGNETOMETER};
    }
    ...
    protected void loadAndStart() {
        Log.d(TAG, "restrict sensors for BASIC_MAGNETOMETER test");
        ChreTestUtil.restrictSensors("com.google.android.gts.locationcontext"
                    + ".GtsContextHubSimpleBasicMagnetometerNanoAppTest");
