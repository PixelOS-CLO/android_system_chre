...
public class GtsContextHubSimpleBasicBarometerNanoAppTest
        extends GtsContextHubSimpleNanoAppTestBase {

    private static final String TAG = "GtsContextHubSimpleBasicBarometerNanoAppTest";
    @Rule public final GtsContextHubTestModeRule mTestModeRule = new GtsContextHubTestModeRule();

    @Override
    protected TestNames[] getTestNames() {
        return new TestNames[] {TestNames.BASIC_BAROMETER};
    }
    ...
    protected void loadAndStart() {
        Log.d(TAG, "restrict sensors for BASIC_BAROMETER test");
        ChreTestUtil.restrictSensors("com.google.android.gts.locationcontext"
                    + ".GtsContextHubSimpleBasicBarometerNanoAppTest");
