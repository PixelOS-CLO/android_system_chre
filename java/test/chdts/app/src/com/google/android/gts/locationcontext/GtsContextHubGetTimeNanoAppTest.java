...
public class GtsContextHubGetTimeNanoAppTest extends GtsContextHubGeneralNanoAppTestBase {
    @Rule public final GtsContextHubTestModeRule mTestModeRule = new GtsContextHubTestModeRule();

    private static final TestNames TEST_NAME = TestNames.GET_TIME;
        ...
        if (mContinueCount == 1) {
            ...
            mTimer.schedule(new TimerTask() {
                    ...
                    public void run() {
                        ...
                        sendMessageToNanoApp(TEST_NAME, MessageType.CONTINUE,
                                             emptyData);
                    }
    ...
    protected long getTestTimeoutSeconds() {
        // We give some extra time for this test since it has a sleep involved.
        return 10;
    }
