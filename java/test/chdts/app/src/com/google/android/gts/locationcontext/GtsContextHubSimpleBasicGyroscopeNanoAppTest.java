...
public class GtsContextHubSimpleBasicGyroscopeNanoAppTest
        extends GtsContextHubSimpleNanoAppTestBase {

    private static final String TAG = "GtsContextHubSimpleBasicGyroscopeNanoAppTest";
    @Rule public final GtsContextHubTestModeRule mTestModeRule = new GtsContextHubTestModeRule();

    @Override
    protected TestNames[] getTestNames() {
        return new TestNames[] {TestNames.BASIC_GYROSCOPE};
    }
    ...
    protected void loadAndStart() {
        Log.d(TAG, "restrict sensors for BASIC_GYROSCOPE test");
        ChreTestUtil.restrictSensors("com.google.android.gts.locationcontext"
                    + ".GtsContextHubSimpleBasicGyroscopeNanoAppTest");
