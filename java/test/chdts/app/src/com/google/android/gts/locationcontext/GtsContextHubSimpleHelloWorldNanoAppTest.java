...
public class GtsContextHubSimpleHelloWorldNanoAppTest extends GtsContextHubSimpleNanoAppTestBase {

    private static final String TAG = "GtsContextSimpleHubHelloWorldNanoAppTest";
    ...
    protected TestNames[] getTestNames() {
        return new TestNames[] {TestNames.HELLO_WORLD};
    }
