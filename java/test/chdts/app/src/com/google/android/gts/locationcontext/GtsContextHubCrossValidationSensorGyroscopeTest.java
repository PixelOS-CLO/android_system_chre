...
/**
 * A test of CHRE gyroscope sensor data as compared to host data.
 */
@RunWith(JUnit4.class)
public final class GtsContextHubCrossValidationSensorGyroscopeTest
    ...
    @Before
    public void setUp() {
        setUpCrossValidator(Sensor.TYPE_GYROSCOPE);
    }
}
