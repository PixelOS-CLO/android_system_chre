...
public class GtsContextHubSimpleHeapExhaustionStabilityNanoAppTest
        extends GtsContextHubSimpleNanoAppTestBase {

    private static final String TAG = "GtsContextHubSimpleHeapExhaustionStabilityNanoAppTest";
    @Rule public final GtsContextHubTestModeRule mTestModeRule = new GtsContextHubTestModeRule();

    @Override
    protected TestNames[] getTestNames() {
        return new TestNames[] {TestNames.HEAP_EXHAUSTION_STABILITY};
    }
