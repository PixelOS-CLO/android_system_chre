...
import com.google.android.chre.test.rpc_service.ContextHubRpcServiceTestExecutor;
...
/**
 * A test to check for CHRE nanoapp RPC services.
 */
@RunWith(AndroidJUnit4.class)
public class GtsContextHubRpcServiceTest extends GtsContextHubTestBase {
    @Rule public final GtsContextHubTestModeRule mTestModeRule = new GtsContextHubTestModeRule();

    private final ContextHubRpcServiceTestExecutor mExecutor = new ContextHubRpcServiceTestExecutor(
            getContextHubManager(), getContextHubInfo(),
            ContextHubHostTestUtil.createNanoAppBinary(getContextHubInfo(),
                    "rpc_service_test.napp"));
