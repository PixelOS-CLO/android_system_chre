...
/**
 * A test of CHRE step counter sensor data as compared to host data.
 */
@RunWith(JUnit4.class)
public final class GtsContextHubCrossValidationSensorStepCounterTest
    ...
    @Before
    public void setUp() {
        setUpCrossValidator(Sensor.TYPE_STEP_COUNTER);
    }
}
