...
/**
 * A test of CHRE accelerometer sensor data as compared to host data.
 */
@RunWith(JUnit4.class)
public final class GtsContextHubCrossValidationSensorAccelerometerTest
    ...
    @Before
    public void setUp() {
        setUpCrossValidator(Sensor.TYPE_ACCELEROMETER);
    }
}
