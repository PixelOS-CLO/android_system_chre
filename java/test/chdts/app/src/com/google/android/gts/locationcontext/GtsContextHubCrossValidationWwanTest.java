...
import com.google.android.chre.test.crossvalidator.ChreCrossValidatorWwan;
...
public class GtsContextHubCrossValidationWwanTest extends GtsContextHubTestBase {
    @Rule public final GtsContextHubTestModeRule mTestModeRule = new GtsContextHubTestModeRule();

    private ChreCrossValidatorWwan mCrossValidator;
    ...
    public void setUp() {
        ...
        NanoAppBinary nappBinary = ContextHubHostTestUtil.createNanoAppBinary(contextHubInfo,
                "chre_cross_validator_wwan.napp");
        mCrossValidator = new ChreCrossValidatorWwan(
