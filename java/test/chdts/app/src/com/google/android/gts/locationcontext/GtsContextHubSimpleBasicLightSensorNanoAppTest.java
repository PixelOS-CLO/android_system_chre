...
public class GtsContextHubSimpleBasicLightSensorNanoAppTest
        extends GtsContextHubSimpleNanoAppTestBase {

    private static final String TAG = "GtsContextHubSimpleBasicLightSensorNanoAppTest";
    @Rule public final GtsContextHubTestModeRule mTestModeRule = new GtsContextHubTestModeRule();

    @Override
    protected TestNames[] getTestNames() {
        return new TestNames[] {TestNames.BASIC_LIGHT_SENSOR};
    }
    ...
    protected void loadAndStart() {
        Log.d(TAG, "restrict sensors for BASIC_LIGHT_SENSOR test");
        ChreTestUtil.restrictSensors("com.google.android.gts.locationcontext"
                    + ".GtsContextHubSimpleBasicLightSensorNanoAppTest");
