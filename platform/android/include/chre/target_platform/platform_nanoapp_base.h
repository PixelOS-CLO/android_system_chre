...
#ifndef CHRE_PLATFORM_ANDROID_PLATFORM_NANOAPP_BASE_H_
#define CHRE_PLATFORM_ANDROID_PLATFORM_NANOAPP_BASE_H_
...
/**
 * CHRE AP specific nanoapp functionality.
 */
...
#endif  // CHRE_PLATFORM_ANDROID_PLATFORM_NANOAPP_BASE_H_
