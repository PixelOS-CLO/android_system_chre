...
#ifndef CHRE_PLATFORM_ANDROID_NOTIFIER_BASE_H_
#define CHRE_PLATFORM_ANDROID_NOTIFIER_BASE_H_
...
/**
 * Storage for CHRE AP implementation of a direct task notifier.
 */
class NotifierBase {
 protected:
...
#endif  // CHRE_PLATFORM_ANDROID_NOTIFIER_BASE_H_
