...
#ifndef CHRE_PLATFORM_ANDROID_CONDITION_VARIABLE_IMPL_H_
#define CHRE_PLATFORM_ANDROID_CONDITION_VARIABLE_IMPL_H_
...
#endif  // CHRE_PLATFORM_ANDROID_CONDITION_VARIABLE_IMPL_H_
