...
#ifndef CHRE_PLATFORM_ANDROID_STATIC_NANOAPP_INIT_H_
#define CHRE_PLATFORM_ANDROID_STATIC_NANOAPP_INIT_H_
...
/**
 * Initializes a static nanoapp that is based on the CHRE AP implementation of
 * PlatformNanoappBase.
 *
...
#define CHRE_STATIC_NANOAPP_INIT(appName, appId_, appVersion_, appPerms)       \
  ...
  UniquePtr<Nanoapp> initializeStaticNanoapp##appName() {                      \
    ...
    appInfo.vendor = "Google"; /* TODO(b/445584823): make this configurable */ \
...
#endif  // CHRE_PLATFORM_ANDROID_STATIC_NANOAPP_INIT_H_
