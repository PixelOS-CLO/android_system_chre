...
const ExportedData kExportedData[] = {
    ...
    ADD_EXPORTED_C_SYMBOL(chreDataFlowCreateAsync),
    ADD_EXPORTED_C_SYMBOL(chreDataFlowDestroy),
    ADD_EXPORTED_C_SYMBOL(chreDataFlowSourceAddSinkAsync),
    ADD_EXPORTED_C_SYMBOL(chreDataFlowSourceAddSinkOverSessionAsync),
    ADD_EXPORTED_C_SYMBOL(chreDataFlowSourceConfigureSink),
    ADD_EXPORTED_C_SYMBOL(chreDataFlowSourceReserve),
    ADD_EXPORTED_C_SYMBOL(chreDataFlowSourceCommit),
    ADD_EXPORTED_C_SYMBOL(chreDataFlowSourcePush),
    ADD_EXPORTED_C_SYMBOL(chreDataFlowSourceGetSize),
    ADD_EXPORTED_C_SYMBOL(chreDataFlowSourceGetCapacity),
    ADD_EXPORTED_C_SYMBOL(chreDataFlowSinkEnable),
    ADD_EXPORTED_C_SYMBOL(chreDataFlowSinkDisable),
