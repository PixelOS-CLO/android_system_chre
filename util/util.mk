...
COMMON_CFLAGS += -I$(PIGWEED_DIR)/pw_multibuf/v1/public
COMMON_CFLAGS += -I$(PIGWEED_DIR)/pw_multibuf/v1_adapter/public
COMMON_CFLAGS += -I$(PIGWEED_DIR)/pw_multibuf/v2/public
